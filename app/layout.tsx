...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', locale: 'ko_KR', siteName: 'OSMU STUDIO', images: [{url: '/og-logo-20260914.png', width: 1200, height: 630, alt: 'OSMU STUDIO 로고'}] },
  twitter: { card: 'summary_large_image', images: ['/og-logo-20260914.png'] },
  icons: {
    icon: [
