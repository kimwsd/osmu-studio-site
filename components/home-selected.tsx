...
export default function HomeSelected(){
  return <div className="home-selected-list">{homeSelected.map((project,projectIndex)=><article id={`project-${project.slug}`} className={`home-selected-case home-selected-${project.slug}`} data-home-project={project.slug} key={project.slug}>
