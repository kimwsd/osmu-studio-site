...
export function FAQ(){return <section className="faq section-pad"><h2>Before we start.</h2><div className="faq-items">{[
...
].map(([q,a])=><details key={q}><summary>{q}<Plus size={20}/></summary><p>{a}</p></details>)}</div></section>}
